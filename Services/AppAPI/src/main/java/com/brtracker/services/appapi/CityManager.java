...
public class CityManager {
	...
	try {
		return ClientCall.post(ControllerInterfaceLookup.getURLPath(ControllerInterfaceLookup.city_ADD,  CONTROLLER_IP), payload);
	...
	public String delete (String payload) {
		try {
			return ClientCall.post(ControllerInterfaceLookup.getURLPath(ControllerInterfaceLookup.city_DELETE,  CONTROLLER_IP), payload);
		} catch (ServiceException e) {
			return ServiceResponseException.generateResponse(e);
		}
		}
	...
	public String list (Long stateId) {
		try {
			String url = ControllerInterfaceLookup.getURLPath(ControllerInterfaceLookup.city_LIST, CONTROLLER_IP);
			String endpoint = url +"?stateId="+stateId;
