...
import com.brtracker.services.controller.AffiliateUserManager;
...
public class AffiliateUserService  {
		...
		/** The user manager. */
		private AffiliateUserManager userHandler = new AffiliateUserManager();
		...
		public AffiliateUserManager getUserHandler() {
			return userHandler;
		}

		public void setUserHandler(AffiliateUserManager userHandler) {
