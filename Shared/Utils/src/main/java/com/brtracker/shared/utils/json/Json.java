package com.brtracker.shared.utils.json;
/*
...
public class Json
{
	 ...
	 */
	public static Json nil() { return Json.topnull; }	
	/**
	 * <p>Return a newly constructed, empty JSON object.</p>
	 */
	public static Json object()	{ return new Json.ObjectJson();	}
	/**
	 ...
	 */
	public static Json array() { return new Json.ArrayJson(); }
	...
	Json() { }
	Json(Json enclosing) { this.enclosing = enclosing; }
	...
	static class NullJson extends Json
	{
		...
		public List<Object> asList() { return (List)Collections.singletonList(null); }
	...
	static class BooleanJson extends Json
	{
		...
		@SuppressWarnings({ "unchecked", "rawtypes" })
		public List<Object> asList() { return (List)Collections.singletonList(val); }
